...
export class WasmMaterial {
  ...
  calculate_macroscopic_xs_neutron(mt_filter?: Array<any> | null): any;
...
export interface InitOutput {
  ...
  readonly wasmmaterial_calculate_macroscopic_xs_neutron: (a: number, b: number) => [number, number, number];
